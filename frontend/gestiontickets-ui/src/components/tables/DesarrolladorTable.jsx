...
//** Opciones de filtro para el estado de los desarrolladores, utilizadas en el componente StatusToggle. */
const statusOptions = [
  { id: "activos", label: "Activos" },
  { id: "inactivos", label: "Inactivos" },
];

export function DesarrolladorTable({
  data = [],
  filter,
  onFilterChange,
  onEdit,
                    ...
                    <div className="flex items-center justify-center gap-2">
                      ...
                      {filter === "activos" ? (
                        <Tooltip text="Eliminar">
                          <button
                            onClick={() => onDelete(desarrollador)}
                        ...
                        <Tooltip text="Restaurar">
                          <button
                            onClick={() => onRestore(desarrollador)}
