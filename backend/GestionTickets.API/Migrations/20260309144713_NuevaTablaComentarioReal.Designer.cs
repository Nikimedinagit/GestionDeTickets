...
namespace GestionTickets.API.Migrations
{
    ...
    [Migration("20260309144713_NuevaTablaComentarioReal")]
    partial class NuevaTablaComentarioReal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionTickets.Generales.ComentarioTicket", b =>
                {
                    b.Property<int>("ComentarioTicketID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ComentarioTicketID"));
            ...
            modelBuilder.Entity("GestionTickets.Models.Generales.Ticket", b =>
                {
                    ...
                    b.HasOne("ApplicationUser", "UsuarioFinalizador")
                        .WithMany()
