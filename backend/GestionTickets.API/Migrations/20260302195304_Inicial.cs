        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaDeComienzo = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UsuarioClienteId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UsuarioFinalizadorId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CategoriaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Desarrollador_Puesto_PuestoID",
                        column: x => x.PuestoID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PuestoCategoria", x => x.PuestoCategoriaID);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PuestoCategoria_Puesto_PuestoID",
                        column: x => x.PuestoID,
                        principalTable: "Puesto",
                        principalColumn: "PuestoID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HistorialTicket_Ticket_TicketID",
                        column: x => x.TicketID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Desarrollador_PuestoID",
                table: "Desarrollador",
                column: "PuestoID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PuestoCategoria_PuestoID",
                table: "PuestoCategoria",
                column: "PuestoID");
